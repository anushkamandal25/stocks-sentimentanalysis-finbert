# FinBERT News Sentiment Trading Strategy Backtester
...
### 1. Clone and install
```bash
git clone https://github.com/anushkamandal25/stocks-sentimentanalysis-finbert.git
...
## Finance Theory
See [`finance.md`](finance.md) for the underlying financial concepts and theory referenced throughout this project (sentiment as a signal, return/volatility definitions, and related background).
